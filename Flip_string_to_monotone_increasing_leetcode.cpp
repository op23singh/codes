...
//int dp[100001][2];
//
//int solve(string s, int n, int last) {
//    if (n >= s.size())return 0;
//    if (dp[n][last] != -1)return dp[n][last];
//    if (last == 0) {
//        if (s[n] == '0') {
//            return dp[n][last] = min(solve(s, n + 1, 0), 1 + solve(s, n + 1, 1));
//        }
//        if (s[n] == '1') {
//            return dp[n][last] = min(1 + solve(s, n + 1, 0), solve(s, n + 1, 1));
//        }
//    } else {
//        if (s[n] == '0') {
//            return dp[n][last] = 1 + solve(s, n + 1, 1);
//        } else {
//            return dp[n][last] = solve(s, n + 1, 1);
//        }
//    }
//    return 0;
//}
